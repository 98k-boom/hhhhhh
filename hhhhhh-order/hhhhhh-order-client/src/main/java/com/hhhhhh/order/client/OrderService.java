package com.hhhhhh.order.client;
...
public interface OrderService {
     ...
     * @return
     */
    JsonResult generateOrder(String userCookieValue, String cartCookieValue, Integer addrId, Integer noAnnoyance, Integer paymentType, String orderId, String shippingName);
}
